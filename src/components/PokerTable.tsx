  ...
  return (
    <div className="w-full flex flex-col items-center space-y-2">
      ...
      <div className="flex items-center justify-between w-full max-w-xl md:max-w-2xl lg:max-w-3xl px-1">
        <div className="text-sm font-bold text-m3-onSurfaceVariant uppercase tracking-wider flex items-center gap-1.5">
          ...
          <div className="flex items-center gap-1 bg-m3-surfaceContainerHigh p-0.5 rounded-m3-xs border border-m3-outlineVariant">
            {([6, 7, 8, 9, 10] as TableSize[]).map((size) => (
              <button
                ...
                className={`px-2.5 py-1 text-xs font-extrabold rounded-m3-xs transition-colors ${
                  tableSize === size
      ...
      <div className="relative w-full max-w-xl md:max-w-2xl lg:max-w-3xl h-64 sm:h-72 md:h-80 lg:h-96 bg-m3-surfaceContainerLow rounded-m3-lg border-2 border-m3-outlineVariant shadow flex items-center justify-center p-4 overflow-hidden my-1">
        ...
        <div className="relative z-10 text-center px-3 py-2 bg-m3-surfaceContainerHigh/90 border border-m3-outlineVariant/80 max-w-[210px] shadow-sm rounded-m3-xs backdrop-blur-sm">
          <div className="text-sm uppercase tracking-wider text-m3-primary font-black leading-tight">
            {spotName}
          </div>
          <div className="text-sm font-semibold text-m3-onSurface mt-0.5 leading-tight">
            {facingAction}
          </div>

          <div className="mt-1.5 pt-1.5 border-t border-m3-outlineVariant/60 grid grid-cols-2 gap-1.5 text-xs font-mono text-zinc-400">
          ...
          return (
            ...
            >
              <button
                ...
                className={`px-3 py-1.5 text-sm font-bold shadow flex items-center gap-1.5 border rounded-m3-xs transition-all hover:scale-110 focus:outline-none ${
                  isHero
              ...
              >
                <span>{pos}</span>
                {isHero && (
                  <span className="text-[11px] bg-amber-400 text-zinc-950 px-1.5 rounded-m3-xs uppercase font-extrabold">
                    Hero
                  </span>
                )}
                {isVillain && (
              ...
              {pos === 'BTN' && (
                <div className="mt-0.5 w-5 h-5 bg-amber-400 text-black text-xs font-black rounded-m3-xs flex items-center justify-center shadow">
                  D
                </div>
              )}
            </div>
