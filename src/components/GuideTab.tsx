...
export const GuideTab: React.FC = () => {
  return (
    <div className="w-full max-w-5xl mx-auto space-y-5 text-m3-onSurface">
      ...
      {/* Header Banner */}
      <div className="bg-m3-surfaceContainerLow border border-m3-outlineVariant/40 rounded-m3-xl p-6 shadow-sm space-y-2">
      ...
      <div className="bg-m3-surfaceContainerLow border border-m3-outlineVariant/40 rounded-m3-xl p-6 shadow-sm space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-1">
          <div className="bg-m3-surfaceContainerHigh p-4 rounded-m3-lg border border-m3-outlineVariant/30">
            <div className="text-xs font-bold text-amber-300 uppercase tracking-wider">Diagonal Cells</div>
            <div className="text-sm font-semibold text-m3-onSurface mt-1">13 Pocket Pairs (AA – 22)</div>
            <p className="text-xs text-m3-onSurfaceVariant mt-1">
          ...
          <div className="bg-m3-surfaceContainerHigh p-4 rounded-m3-lg border border-m3-outlineVariant/30">
            ...
            <div className="text-sm font-semibold text-m3-onSurface mt-1">78 Suited Hands (e.g. AKs)</div>
            <p className="text-xs text-m3-onSurfaceVariant mt-1">
          ...
          <div className="bg-m3-surfaceContainerHigh p-4 rounded-m3-lg border border-m3-outlineVariant/30">
            ...
            <div className="text-sm font-semibold text-m3-onSurface mt-1">78 Offsuit Hands (e.g. AKo)</div>
            <p className="text-xs text-m3-onSurfaceVariant mt-1">
      ...
      <div className="bg-m3-surfaceContainerLow border border-m3-outlineVariant/40 rounded-m3-xl p-6 shadow-sm space-y-4">
        ...
        <div className="space-y-3">
          <div className="bg-m3-surfaceContainerHigh p-3.5 rounded-m3-lg border border-m3-outlineVariant/30 flex justify-between items-center text-xs">
            <div>
              <span className="font-semibold text-m3-primary">Under The Gun (UTG)</span>
            ...
            <span className="px-3 py-1 bg-m3-surfaceContainerHighest text-m3-onSurfaceVariant rounded-m3-full font-medium">Tightest</span>
          </div>

          <div className="bg-m3-surfaceContainerHigh p-3.5 rounded-m3-lg border border-m3-outlineVariant/30 flex justify-between items-center text-xs">
            <div>
              <span className="font-semibold text-m3-primary">Button (BTN)</span>
            ...
            <span className="px-3 py-1 bg-m3-primaryContainer text-m3-onPrimaryContainer rounded-m3-full font-medium">Widest</span>
          </div>

          <div className="bg-m3-surfaceContainerHigh p-3.5 rounded-m3-lg border border-m3-outlineVariant/30 flex justify-between items-center text-xs">
            <div>
              <span className="font-semibold text-m3-primary">Big Blind (BB)</span>
            ...
            <span className="px-3 py-1 bg-m3-tertiaryContainer text-m3-onTertiaryContainer rounded-m3-full font-medium">Defensive</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-m3-surfaceContainerLow border border-m3-outlineVariant/40 rounded-m3-xl p-6 shadow-sm space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
          <div className="bg-m3-surfaceContainerHigh p-4 rounded-m3-lg border border-m3-outlineVariant/30 space-y-1.5">
            <h4 className="font-semibold text-amber-300 text-xs">High Card Domination</h4>
          ...
          <div className="bg-m3-surfaceContainerHigh p-4 rounded-m3-lg border border-m3-outlineVariant/30 space-y-1.5">
            <h4 className="font-semibold text-m3-primary text-xs">Suitedness & Barrel Power</h4>
            <p className="text-m3-onSurfaceVariant leading-relaxed">
          ...
          <div className="bg-m3-surfaceContainerHigh p-4 rounded-m3-lg border border-m3-outlineVariant/30 space-y-1.5">
            <h4 className="font-semibold text-blue-300 text-xs">Ace Blockers & 3-Bet Bluffs</h4>
            <p className="text-m3-onSurfaceVariant leading-relaxed">
          ...
          <div className="bg-m3-surfaceContainerHigh p-4 rounded-m3-lg border border-m3-outlineVariant/30 space-y-1.5">
            <h4 className="font-semibold text-purple-300 text-xs">Connectivity & Implied Odds</h4>
            <p className="text-m3-onSurfaceVariant leading-relaxed">
